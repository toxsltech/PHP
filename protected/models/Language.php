...
class Language extends \app\components\TActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'language_file' => Yii::t('app', 'Language File'),
    ...
    public function beforeDelete()
    {
        ...
        // Delete actual file
        $filePath = UPLOAD_PATH . $this->language_file;
    ...
    public function asJson($with_relations = false)
    {
        ...
        if (isset($this->language_file)) {
            $json['language_file'] = $this->getUrl('image');
            $json['language_file'] = $this->getImageUrl();
        } else {
            $json['language_file'] = '';
        }
    ...
    public static function addTestData($count = 1)
    {
        ...
        for ($i = 0; $i < $count; $i ++) {
            ...
            $model->language_file = $faker->text(10);
    ...
    public static function addData($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $model->language_file = isset($item['language_file']) ? $item['language_file'] : $faker->text(10);
    ...
    public function getImageUrl($thumbnail = false)
    {
        ...
        if (isset($this->language_file) && ! empty($this->language_file)) {
            $params['file'] = $this->language_file;
        }
