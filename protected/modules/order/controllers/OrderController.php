...
use app\modules\order\models\search\Order as OrderSearch;
...
class OrderController extends TController
{
    ...
    public function actionClone($id)
    {
        ...
        // $model->id = $old->id;
        $model->product_id = $old->product_id;
        $model->address_id = $old->address_id;
        $model->tip = $old->tip;
        $model->is_pickup = $old->is_pickup;
        $model->amount = $old->amount;
        $model->tax = $old->tax;
        $model->total_amount = $old->total_amount;
        $model->preparing_time = $old->preparing_time;
        $model->estimated_time = $old->estimated_time;
        $model->payment_type = $old->payment_type;
