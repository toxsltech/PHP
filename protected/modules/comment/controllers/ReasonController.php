...
use app\modules\comment\models\search\Reason as ReasonSearch;
 ...
 */
class ReasonController extends TController
{
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Reason::STATE_ACTIVE;
    ...
    /**
     * Clone an existing Reason model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    /**
     * Truncate an existing Reason model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Reason Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
