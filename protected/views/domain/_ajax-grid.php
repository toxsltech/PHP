 ...
 * @var app\models\search\Domain $searchModel
 */
...
<?php Pjax::begin(['id'=>'domain-pjax-ajax-grid','enablePushState'=>false,'enableReplaceState'=>false]); ?>
    <?php

echo TGridView::widget([
        'id' => 'domain-ajax-grid-view',
