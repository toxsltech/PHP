...
<div class="col-lg-6">
	...
	<div class="col-lg-6">
                ...
                <?php
                echo $form->field($model, 'emoji_file', [
                    'enableClientValidation' => ! empty($model->emoji_file) ? false : true,
	...
	<div class="col-md-12 text-right">
      <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Save') : Yii::t('app', 'Update'), ['id'=> 'emoji-form-submit','class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
   </div>
   <?php TActiveForm::end(); ?>
</div>