...
<div class="wrapper">
   <div class="card">
      <div class="subscription-billing-view card-body">
   ...
   <div class="card">
      <div class="card-body">
         ...
         'id'	=> 'subscription-billing-detail-view',
         'model' => $model,
         ...
         ?>         <div class="col-md-12 text-right">
            <?= Html::submitButton('Confirm', ['id'=> 'subscription--billing-form-submit','class' =>'btn btn-success']) ?>
         </div>
         <?php TActiveForm::end(); ?>
      </div>
   </div>
      ...
      <div class="card-body">
         <div
            class="subscription-billing-panel">
            <?php
