...
class LanguageController extends TController
{
    ...
    public function actionAdd()
    {
        ...
        if ($model->load($post)) {
            $model->saveUploadedFile($model, 'language_file');
            if ($model->save()) {
                Yii::$app->getSession()->setFlash('success', 'Language Added Successfully.');
    ...
    /**
     * Clone an existing Language model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    public function actionClone($id)
    {
        ...
        $model->language_file = $old->language_file;
