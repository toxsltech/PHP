...
use app\models\search\Charity as CharitySearch;
 ...
 */
class CharityController extends TController
{
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'allow' => true,
                        'matchCallback' => function () {
                        return User::isAdmin()||User::isUser()||User::isGuest()||User::isSubAdmin();
                        }
                        ],
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Charity::STATE_ACTIVE;
    ...
    /**
     * Clone an existing Charity model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    public function actionClone($id)
    {
        ...
        $model->goal_amount = $old->goal_amount;
        $model->description = $old->description;
        $model->raised_amount = $old->raised_amount;
        $model->min_amount = $old->min_amount;
        $model->max_amount = $old->max_amount;
    ...
    /**
     * Truncate an existing Charity model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Charity Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
