...
use app\models\search\Emoji as EmojiSearch;
 ...
 */
class EmojiController extends TController
{
    ...
    public function actions()
    {
        return [
            'image' => [
                ...
                'modelClass' => Emoji::class,
                'attribute' => 'emoji_file'
            ]
        ];
    }
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Emoji::STATE_ACTIVE;
        $model->scenario = 'add';
        ...
        if ($model->load($post)) {
            ...
            if ($model->save()) {
                Yii::$app->getSession()->setFlash('success', 'Emoji Added Successfully.');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load($post)) {
            $model->emoji_file = $old_image;
            $model->saveUploadedFile($model, 'emoji_file');
            if ($model->save()) {
                Yii::$app->getSession()->setFlash('success', 'Emoji Update Successfully.');
                return $this->redirect($model->getUrl());
            }
        }
    ...
    public function actionClone($id)
    {
        ...
        $model->emoji_file = $old->emoji_file;
    ...
    public function actionDelete($id)
    {
        ...
        if (\yii::$app->request->post()) {
            $model->delete();
            Yii::$app->getSession()->setFlash('success', 'Emoji Deleted Successfully.');
    ...
    /**
     * Truncate an existing Emoji model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Emoji Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
