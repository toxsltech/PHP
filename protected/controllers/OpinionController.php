...
use app\models\search\Opinion as OpinionSearch;
 ...
 */
class OpinionController extends TController
{
    ...
    /**
     * Clone an existing Opinion model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    /**
     * Truncate an existing Opinion model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Opinion Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
