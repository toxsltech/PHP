...
use app\models\User;
use app\models\search\Package as PackageSearch;
use Yii;
 ...
 */
class PackageController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Package::STATE_ACTIVE;
        $model->type_id=Package::PACKAGE;
        /*
         * if (is_numeric($id)) {
    ...
    /**
     * Clone an existing Package model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    /**
     * Truncate an existing Package model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Package Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
