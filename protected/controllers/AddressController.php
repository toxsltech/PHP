...
class AddressController extends TController
{
    ...
    public function actionClone($id)
    {
        ...
        $model->first_name = $old->first_name;
        $model->last_name = $old->last_name;
        $model->primary_address = $old->primary_address;
        $model->secondary_address = $old->secondary_address;
        $model->city = $old->city;
        $model->state = $old->state;
        $model->country = $old->country;
        $model->zipcode = $old->zipcode;
        $model->contact_no = $old->contact_no;
        $model->no_of_box = $old->no_of_box;
        $model->date = $old->date;
        $model->time = $old->time;
    ...
    /**
     * Truncate an existing Address model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Address Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
