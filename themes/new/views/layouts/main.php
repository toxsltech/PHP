...
<link
	...
	rel="stylesheet">
	<link
	href="<?php echo $this->theme->getUrl('css/all.css')?>"
	rel="stylesheet">
...
<body
      ...
      <section class="position-relative">
		...
		<div class="sidebar-left  style-scroll">
			...
			<div class="logo theme-logo-bg  d-block d-xl-none">
				<a href="<?= Url::home();?>" class="logo-hidden">
					<h3 class="text-white mb-0"><?=Yii::$app->name?></h3>
				</a> <a href="<?= Url::home();?>" class="logo-show text-white">
					<h3 class="text-text-white mb-0"><?=Yii::$app->name?></h3>
				</a>
			</div>
		...
		<div class="body-content">
			...
			<div class="header-section ">
				...
				<!--toggle button start-->
				<a class="toggle-btn">
                  <span class="toggle-line top-sm-line"></span>
                           <span class="toggle-line lg-line"></span>
                           <span class="toggle-line bottom-sm-line"></span>
                  </a>
				<!--toggle button end-->
				
				<!--mega menu start-->
				<div class='pull-left'>
					<div class="search-form custom-search-wrapper">
                     <?php
                    ...
                    ?>
					<span class="search-ic"><i class="fa fa-search"></i></span>
				...
				<!--mega menu end-->
				<div class="notification-wrap  ml-auto">
					<!--right notification start-->
					<div class="right-notification mr-0">
        ...
        ?>"> <i
											class="fa fa-user float-right"></i> Profile
									</a></li>
									<li><a
										href="<?php
        echo Yii::$app->user->identity->getUrl('changepassword');
        ?>"> <span
											class="fa fa-key float-right"></span> <span>Change Password</span>
									</a></li>
									<li><a
										href="<?php
        echo Yii::$app->user->identity->getUrl('update');
        ?>"> <span
											class="fa fa-pencil float-right"></span> Update
									</a></li>
									<li><a
										href="<?php
        echo Url::toRoute([
        ...
        ?>"> <i
											class="fa fa-sign-out float-right"></i> Log Out
									</a></li>
	...
	<script src="<?php echo $this->theme->getUrl ( 'js/notify.js' )?>"></script>
	<script
